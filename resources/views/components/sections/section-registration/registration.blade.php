<section id="pendaftaran" class="w-11/12 flex flex-col gap-40 py-20 xs:py-30">
    <div>
        <h3 data-aos="fade-down" data-aos-delay="200" class="flex w-11/12 mb-4 items-center gap-2 text-[0.8em] xs:text-sm">
        ...
        <h2 class="font-bold text-4xl mb-10 text-[#1d1d1d]" data-aos="fade-down">Wujudkan Mimpimu Bersama Sekolah
            Kami</h2>
        <div class="w-full h-60 xs:h-70 sm:h-170" data-aos="fade-up">
    ...
    <div class="w-full h-70 sm:h-170" data-aos="fade-up">
