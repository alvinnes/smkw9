<div class="flex flex-col w-[38rem] gap-6" data-aos="fade-left" data-aos-delay="200">
    ...
    <p> Saat ini, SMK Walisongo Pecangaan memiliki empat program keahlian utama: Desain Dan Produksi Kriya,
        Teknik
        Otomotif, Akuntansi Dan Keuangan Lembaga, dan Teknik Jaringan Komputer Dan Telekomunikasi. Sekolah ini
        telah terakreditasi B serta tersertifikasi ISO 9001:2008, menjadikannya lembaga
    ...
    <button class="font-semibold text-white bg-[#1d1d1d] py-3.5 px-2 rounded-md w-[15rem]">
        <a href="/detail">Baca Selengkapnya</a></button>
</div>
