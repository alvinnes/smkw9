 <footer
     class="w-full text-white py-14 px-10 bg-primary flex flex-col sm:flex-row gap-6 sm:gap-0 items-center xs:items-start justify-around">
     <div class="sm:w-100 w-full xs:w-80 flex flex-col xs:flex-row items-center xs:items-start gap-4">
         <img src="{{ asset('/img/logo-smk.png') }}" alt="logo-smk" class="size-50 xs:size-30">
         <div>
             <h2 class="font-bold text-xl">SMK Walisongo Pecangaan Jepara</h2>
             <p class="text-[0.8em] sm:text-sm mt-1">Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic,
                 perspiciatis.</p>
     ...
     <ul class="text-sm flex flex-col gap-1.5 w-full xs:w-60">
     ...
     <div class="flex flex-col gap-1.5 w-full xs:w-50">
