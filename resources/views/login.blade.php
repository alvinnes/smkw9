<x-layout.form-layout>
    ...
    <main class="flex flex-col md:flex-row w-full min-h-screen bg-gradient-to-br from-slate-50 to-white">
        <div
            ...
            <form action="/masuk" method="post"
                ...
                <div class="mb-2 sm:mb-4">
                    <h2 class="text-xl sm:text-2xl md:text-3xl text-[#1d1d1d] font-bold mb-2">Login Sekarang!</h2>
                </div>
                ...
                <p class="text-xs sm:text-sm text-center text-slate-600">
                    Tidak punya akun?
                    <a href="/daftar" class="text-primary font-semibold hover:underline transition-all">buat akun</a>
                    sekarang!
                </p>
            </form>
        </div>
        ...
        <div class="hidden md:block w-7/12 min-h-screen bg-primary relative overflow-hidden order-1 md:order-2">
            ...
            <div
                class="absolute bottom-16 lg:bottom-24 left-1/2 -translate-x-1/2 text-white text-center w-[90%] lg:w-[80%] max-w-xl flex flex-col items-center z-20">
                <h2 class="text-2xl lg:text-4xl xl:text-5xl leading-tight lg:leading-tight mb-3 lg:mb-4 font-bold"
                    data-aos="fade-down">
                    Masuk ke Portal SMK Walisongo Pecangaan
                </h2>
                <p class="font-light text-sm lg:text-base text-white/90 max-w-md lg:max-w-lg" data-aos="fade-up"
                    data-aos-delay="300">
                    Gunakan akun resmi Anda untuk mengakses jadwal, nilai, dan informasi terbaru dari sekolah dalam satu
                    tempat.
                </p>
            </div>
        ...
        <div class="block md:hidden w-full h-50 sm:h-56 relative order-1">
            ...
            <div class="absolute bottom-4 left-4 right-4 text-white z-20 w-9/12">
                <h2 class="text-lg sm:text-xl font-bold mb-1" data-aos="fade-up">Masuk ke Portal SMK Walisongo Pecangaan
                </h2>
                <p class="text-xs w-full sm:text-sm text-white/80" data-aos="fade-up" data-aos-delay="100"> Gunakan akun
                    resmi
                    Anda untuk mengakses jadwal, nilai, dan informasi terbaru dari sekolah dalam satu
                    tempat.</p>
            </div>
        </div>
    </main>
