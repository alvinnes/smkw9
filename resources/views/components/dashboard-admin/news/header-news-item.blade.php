 <div class="flex items-center gap-2">
     <div class="bg-slate-100/50 group relative cursor-pointer p-2 rounded-sm">@svg('lucide-ellipsis-vertical', 'size-4')
         <div
             class="absolute w-35 py-1  opacity-0 group-hover:opacity-100 transition-all duration-500 px-1.5 bg-white shadow-sm rounded-md -right28 top-10">
             <button type="button"
 ...
 <x-modal.modal-delete name="berita" clicked="deleteNews()"></x-modal.modal-delete>
